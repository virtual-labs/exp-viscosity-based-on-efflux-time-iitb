...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(rect_tank, new Chemistry.Point(300, 500), 276, 394, canvas);
    sq.name = "rect_tank";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(collecting_tank, new Chemistry.Point(800, 500), 206, 393, canvas);
    sq.name = "collecting_tank";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(timer, new Chemistry.Point(1400, 500), 461, 224, canvas);
    sq.name = "timer";
    scene.add(sq);
}
...
{
    question = [];
    question.push({ srno: 1, question: "Select <span style='color: #018fc3'> Rectangular Tank </span>", ans: "rect_tank", hint: ["Has Suction and Discharge", "Has valve attached", "Triangular Base"] });
    question.push({ srno: 2, question: "Select <span style='color: #018fc3'> Collecting Tank </span>", ans: "collecting_tank", hint: ["Rectangular", "Mounted Vertically", "Has valves attached"] });
...
function load_higlighted_images() {
    highlighted_images = [
        [rect_tank, rect_tank],
        [collecting_tank, collecting_tank],
        [timer, timer],
    ];
    a1_labels = [
